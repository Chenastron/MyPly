...
_lr_productions = [
  ...
  ('stmt -> FOR VAR IN range COLON stmt_print SPLIT','stmt',7,'p_stmt_print_for','dparser.py',57),
  ('stmt -> stmt_print IF condition_list ELSE stmt_print SPLIT','stmt',6,'p_stmt_print_cond_postfix_else','dparser.py',62),
  ('if_assign -> VAR ASSIGN expression','if_assign',3,'p_ifassign','dparser.py',67),
  ...
  ('stmt -> VAR ASSIGN expression SPLIT','stmt',4,'p_stmt_print_assign','dparser.py',94),
  ('stmt -> VAR ASSIGN condition_list SPLIT','stmt',4,'p_stmt_print_assign','dparser.py',95),
  ...
  ('expression -> VAR','expression',1,'p_expression_var','dparser.py',146),
